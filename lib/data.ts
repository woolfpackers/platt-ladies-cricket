  ...
  return ((playersData ?? []) as any[]).map((player) => ({
    ...
    sponsor: player.sponsor_id
      ? {
          ...
          title: player.sponsor_title,
          logo_url: player.sponsor_logo_url,
          website_url: player.sponsor_website_url,
          intro: player.sponsor_intro,
          body: player.sponsor_body,
          body_2: player.sponsor_body_2,
